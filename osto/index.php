<?php
    ...
    /* Anna tämän kommentin alle komento, jossa asetetaan oletus aikavyöhykkeeksi 
    ('Europe/Helsinki'), jota käytetään myöhemmin kaikissa tähän tiedostoon lisättävissä 
    päivämäärä- ja aikatoiminnoissa.
    */ 
    ...
    while ($i < $num) {
        ...
        (isset($_SESSION['kayttaja_taso']) AND $_SESSION['kayttaja_taso'] == "admin")) {
            echo "<tr><td><form action='poistailmoitus.php' method='post'/>
            ...
            <input type='submit' value='Muokkaa'></form></td></tr>";
        }
        echo "</table></p>";
        $i++;
    }
    ...
    <input type='submit' name='submit' value='Hae'></form></p></td></tr>"; 
